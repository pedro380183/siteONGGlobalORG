...
function FormVoluntario() {
  return (
    ...
    >
      <Label htmlFor="name">Nome da Organização sem Fins Lucrativos:</Label>
...
export default function CadastroOng() {
  return (
    <div
      ...
      <h1 style={{ textAlign: "center" }}>Criar Conta como Ong</h1>
      <p
        style={{
          textAlign: "center",
        }}
      >
        Crie uma conta para organizar suas equipes
      </p>
